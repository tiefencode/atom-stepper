...
// Coast behavior
static const float DECAY = 0.95f;     // higher = less glide between ticks

// Hard stop behavior
static const float STOP_TRIGGER_FACTOR = 1.55f; // lower = stop logic starts earlier after missed step
static const uint32_t STOP_MIN_MS = 560;        // minimum delay before hard stop can engage
...
static const float LED_SPEED_DIVISOR = 20000.0f;                  // single tuning value for speed -> pulse period
